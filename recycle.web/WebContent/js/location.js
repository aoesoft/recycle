...
var provinceHtml = '<div class="content"><div data-widget="tabs" class="m stock" id="stock">'
								+'<div class="mt">'
								+'    <ul class="tab">'
...
/**
 * getAreaListcallback([{"name":"\u83b1\u897f\u5e02","id":1014},{"name":"\u56db\u65b9\u533a","id":3519},{"name":"\u5e02\u5317\u533a","id":3520},{"name":"\u5e02\u5357\u533a","id":3521}])
 */
...
function chooseCity(cityId,cityName){
	...
	//getAreaListcallback(provinceCityJson[""+cityId]);
...
var areaTabContainer=$("#stock .tab li");
...
(function(){
	$("#store-selector").unbind("mouseover").bind("mouseover",function(){
		...
		$("#store-selector .content,#stock").show();
	}).find("dl").remove();
	CurrentAreaInfoInit();
